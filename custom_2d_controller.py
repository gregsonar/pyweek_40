...
class Custom2dController(Entity):
    """Copy from ursina.prefabs.platformer_controller_2d but WITHOUT little blue square and tons of commented code
    Big thanks to github.com/pokepetter/ursina/issues/720 for pointing out!"""
